...
const ATTRIBUTE_DEFINITIONS = Object.freeze([
  ...
  definition(
    ...
    ENUM_OPERATORS,
    value('orchestration.runStatus'),
    { auditDisplaySafe: true },
  ),
  definition(
    'orchestration.nodeStatus',
    'enum',
    'Authoritative orchestration node status.',
    ENUM_OPERATORS,
    value('orchestration.nodeStatus'),
    { auditDisplaySafe: true },
  ),
  definition(
    'orchestration.failureCategory',
    'enum',
    'Safe orchestration failure category.',
    ENUM_OPERATORS,
    value('orchestration.failureCategory'),
    { auditDisplaySafe: true },
  ),
  definition(
    'orchestration.healthCategory',
    'enum',
    'Safe orchestration run health category.',
    ENUM_OPERATORS,
    value('orchestration.healthCategory'),
    { auditDisplaySafe: true },
  ),
  definition(
    'orchestration.sloStatus',
    'enum',
    'Safe orchestration SLO evaluation status.',
    ENUM_OPERATORS,
    value('orchestration.sloStatus'),
    { auditDisplaySafe: true },
  ),
  definition(
    'orchestration.alertSeverity',
    'enum',
    'Safe orchestration alert severity.',
    ENUM_OPERATORS,
    value('orchestration.alertSeverity'),
    { auditDisplaySafe: true },
  ),
  definition(
    'orchestration.operationalAction',
    'enum',
    'Controlled orchestration operation action.',
    ENUM_OPERATORS,
    value('orchestration.operationalAction'),
    { auditDisplaySafe: true },
  ),
  definition(
    'orchestration.criticalityCategory',
    'enum',
    'Declared orchestration criticality category.',
    ENUM_OPERATORS,
    value('orchestration.criticalityCategory'),
    { auditDisplaySafe: true },
  ),
  definition(
    'orchestration.classificationCategory',
    'enum',
    'Declared orchestration data classification category.',
    ENUM_OPERATORS,
    value('orchestration.classificationCategory'),
    { auditDisplaySafe: true },
  ),
  definition(
    'orchestration.trustTier',
    'enum',
    'Declared orchestration agent trust tier.',
    ENUM_OPERATORS,
    value('orchestration.trustTier'),
    { auditDisplaySafe: true },
  ),
  definition(
    'worker.healthCategory',
    'enum',
    'Safe orchestration worker-fleet health category.',
    ENUM_OPERATORS,
    value('worker.healthCategory'),
    { auditDisplaySafe: true },
  ),
]);
