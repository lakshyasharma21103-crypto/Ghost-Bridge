...
const orchestrationTraceSpanSchema = new mongoose.Schema(
  {
    ...
    targetRegionId: { type: String, trim: true, maxlength: 128 },
    authorityEpoch: { type: Number, min: 0 },
    failoverPlanId: { type: mongoose.Schema.Types.ObjectId, ref: 'RegionalFailoverPlan', index: true },
    failoverStepKey: { type: String, trim: true, maxlength: 128 },
    regionalParentSpanId: { type: String, trim: true, match: SAFE_IDENTIFIER_PATTERN, maxlength: 128 },
