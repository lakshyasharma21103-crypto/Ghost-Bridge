...
passportInstallKeySchema.index({ usedByWorkspaceId: 1, status: 1, usedAt: -1 });

module.exports =
  mongoose.models.PassportInstallKey ||
  mongoose.model('PassportInstallKey', passportInstallKeySchema);
