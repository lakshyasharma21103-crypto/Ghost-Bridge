...
const { platformNativeClientRouter } = require('./platformNativeClientRoutes');
...
router.use(`${API_PREFIX}/platform-native`, platformNativeClientRouter);
...
if (env.EXPERIMENTAL_AGENT_COORDINATION_ENABLED) {
