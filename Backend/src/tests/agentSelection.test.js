...
test('permission registry v9 separates discovery, selection and inter-agent delegation administration', () => {
  const registry = getPermissionRegistry(); assert.equal(registry.version, 9);
