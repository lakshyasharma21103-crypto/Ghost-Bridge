...
| `GEMINI_RESEARCH_TIMEOUT_MS`   | No       | `180000`      | Deadline for the grounded-research operation, including its bounded retry.                                                                             |
| `GEMINI_FORMATTING_TIMEOUT_MS` | No       | `90000`       | Deadline for the structured-formatting operation, including its bounded retry.                                                                         |
